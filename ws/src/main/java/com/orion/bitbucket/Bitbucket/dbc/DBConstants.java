...
public class DBConstants {
    ...
    private static final String CREATE_REVIEW_TABLE = "CREATE TABLE IF NOT EXISTS review (ID INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, REVIEWER_ID INT NOT NULL, DISPLAY_NAME TEXT NOT NULL, EMAIL_ADDRESS TEXT NOT NULL, APPROVED BOOLEAN NOT NULL, STATUS TEXT NOT NULL)";
