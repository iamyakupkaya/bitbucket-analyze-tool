...
public class DBConstants {
    ...
    private static final String CREATE_PULL_REQUEST_TABLE = "CREATE TABLE IF NOT EXISTS pullRequest (ID INT PRIMARY KEY NOT NULL, VERSION INT NOT NULL, TITLE TEXT NOT NULL, STATE TEXT NOT NULL, CLOSED BOOLEAN, DESCRIPTION TEXT NOT NULL,UPDATE_DATE TEXT NOT NULL ,CREATED_DATE DATE NOT NULL, CLOSED_DATE DATE NOT NULL, EMAIL_ADDRESS TEXT NOT NULL, DISPLAY_NAME TEXT NOT NULL, SLUG TEXT NOT NULL)";
    ...
    private static final String CREATE_ADMINISTRATOR_TABLE = "CREATE TABLE IF NOT EXISTS administrator (ID NUMERIC PRIMARY KEY NOT NULL, USERNAME TEXT NOT NULL, PASSWORD TEXT NOT NULL,ROLE TEXT NOT NULL)";
    ...
    public static ArrayList<String> getCreateTableQueries() {
        ...
        list.add(CREATE_ADMINISTRATOR_TABLE);
        return list;
    }
    ...
    public static final class PullRequest {
        ...
        public static final String PULL_REQUEST_VERSION = "version";
