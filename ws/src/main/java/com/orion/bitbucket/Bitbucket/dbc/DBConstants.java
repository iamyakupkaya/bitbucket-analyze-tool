...
public class DBConstants {
    ...
    private static final String CREATE_USER_TABLE = "CREATE TABLE IF NOT EXISTS user (ID INT PRIMARY KEY NOT NULL, NAME TEXT NOT NULL, MANAGER TEXT NOT NULL, TEAM_CODE NOT NULL, EMAIL_ADDRESS TEXT NOT NULL, SLUG TEXT NOT NULL)";
