...
! function () {
    ...
    i = document.querySelector("#growthChart"), s = {
        series: [78],
        labels: ["Growth"],
        chart: {
            height: 240,
    ...
    i = document.querySelector("#profileReportChart"), s = {
        chart: {
            height: 80,
            type: "line",
            toolbar: {
    ...
    o = document.querySelector("#incomeChart"), t = {
        series: [{
    ...
    i = document.querySelector("#expensesOfWeek"), s = {
        series: [65],
        chart: {
            width: 60,
            height: 60,
