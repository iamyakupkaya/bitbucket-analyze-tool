...
@Document("allPRS")
public class AllPrsEntity extends CommonBaseEntity implements ITopEntity {

    private PRValuesEntity values; // List<ValuesEntity>
    public AllPrsEntity(){};

    public AllPrsEntity(int size, int limit, boolean isLastPage, int start, int nextPageStart, PRValuesEntity values) {
